...
while true
    ...
    if iteration_counter == 1
        ...
        alpha_valtozo = ((current_gradient-previous_gradient)'*current_gradient)/(previous_gradient'*previous_gradient);
        M = -current_gradient + alpha_valtozo*previous_M;
    end
